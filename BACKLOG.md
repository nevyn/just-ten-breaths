...
Fullscreen:
- [ ] Add a tiny "double fullscreen arrow" button to the breathe window
- [ ] Clicking the fullscreen arrow button, or double clicking on the flower itself, should fullscreen the flower window
